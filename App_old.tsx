...
const Logo = ({ className, size = 'default' }: { className?: string; size?: 'small' | 'default' | 'large' | 'hero' }) => {
  ...
  return (
    ...
    >
      <img src="/logo-light.svg" alt="colaboraEDU" className={sizes[size]} />
    </motion.div>
  );
};

// Feature Badge Component
const FeatureBadge = ({ icon: Icon, text }: { icon: React.ComponentType<{ className?: string }>; text: string }) => (
  <motion.div
    ...
    <div className="container mx-auto px-4">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        <div className="col-span-1 md:col-span-2">
          <img src="/logo-dark.svg" alt="colaboraEDU" className="h-14 mb-4" />
...
const App: React.FC = () => {
  ...
  const handleLogin = async (email: string, password: string): Promise<void> => {
    ...
    try {
      ...
      const isValid = await validateCredentials(selectedProfile.id, email, password);
      ...
      throw new Error(error instanceof Error ? error.message : 'Erro durante o login. Tente novamente.');
    }
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 font-sans antialiased">
      ...
      <main className="relative flex flex-col min-h-screen">
            ...
            >
              ...
              <div className="flex gap-2 md:gap-3">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() => {
                    const element = document.getElementById('profile-selection');
                ...
                >
                  <span className="w-4 h-4"><FiLogIn /></span>
            ...
            <div className="text-center text-white">
              ...
              >
                <motion.div
                  ...
                  whileHover={{ scale: 1.05 }}
                >
                  <span className="text-yellow-300"><FiZap /></span>
        ...
        <section id="profile-selection" className="flex-grow py-16 px-4">
          <div className="container mx-auto max-w-7xl">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-4">
                Selecione seu <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Perfil</span>
              </h2>
              <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                Escolha o tipo de usuário para acessar as funcionalidades específicas do seu perfil e comece a transformar sua experiência educacional.
              </p>
            </motion.div>
